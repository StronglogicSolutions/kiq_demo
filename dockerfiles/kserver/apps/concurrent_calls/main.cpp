...
/**
 * Returns the maximum number of concurrent calls from a vector of sipcall
 * values
 *
 * @helper
...
/**
 * Creates a sipcall from 2 double values representing the start and end times
 * of the call
 *
 ...
 *
 * @param[in|out] {std::tuple<double, double>|sipcall} calls A vector of
 * sipcalls to which to add a call
 * @param[in] {double} start The start time of the call
 * @param[in] {double} end The end time of the call
 * @helper
 */
